...
// 1. All constexpr variables are const.
...
//    If the compiler only sees the declaration of GetValue() but not its definition
//    (like GetValue() declared in foo.h and be pasted with include "foo.h" in main.cpp, but it's definition in foo.cpp)
